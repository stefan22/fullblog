        ...
        <div className="w-full p-0 md:px-4 md:py-2 lg:w-1/2">
          <StaggerContainer staggerDelay={0.08}>
            <StaggerItem yOffset={14}>
              <h1 className="text-4xl px-4 pt-4 font-semibold text-gray-700 text-center">
                Because your 3am <br />
              </h1>
            </StaggerItem>
            <StaggerItem yOffset={14}>
              <p className="text-xl text-gray-500 text-center mt-2 mb-0 md:mb-8">
          ...
          <div className="flex flex-col justify-center w-full">
            <BlurFade delay={0.18}>
              <Card className="ring-0 rounded-lg md:shadow-lg mb-4 md:mb-0 md:px-4 py-6">
                <CardHeader>
                  <BlurFade delay={0.22}>
